...
public class Crosshair
{
    ...
    public void Load()
    {
        ...
        //*/
        //*
        mesh.Vertex(-4.0f,  0.0f,  0.0f);
        mesh.Vertex( 5.0f,  0.0f,  0.0f);
        mesh.Vertex( 5.0f,  1.0f,  0.0f);
        mesh.Vertex(-4.0f,  1.0f,  0.0f);

        mesh.Vertex( 0.0f, -4.0f,  0.0f);
        mesh.Vertex( 1.0f, -4.0f,  0.0f);
        mesh.Vertex( 1.0f,  5.0f,  0.0f);
        mesh.Vertex( 0.0f,  5.0f,  0.0f);
        //*/
    ...
    public Matrix4 CreateOrthographicOffCenter(int screenWidth, int screenHeight)
    {
        float left = 0.0f;
